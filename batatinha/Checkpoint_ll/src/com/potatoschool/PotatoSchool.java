...
public class PotatoSchool { // Classe que representa nossa "Escola" que possui professores
    ...
    public void removerAluno(){
        ...
        System.out.println("Selecione o professor do aluno");
        ...
        for (int i=0 ; i < listaProfessores.get(opcaoProfessor).getListaAluno().size(); i++){
            System.out.println(i + "- " + listaProfessores.get(opcaoProfessor).getListaAluno().get(i));
        }
        int opcaoAluno = scanner.nextInt();

        listaProfessores.get(opcaoProfessor).getListaAluno().remove(opcaoAluno);
